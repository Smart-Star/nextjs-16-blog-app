...
export default function SearchInput() {
  ...
  return (
    <div className='relative z-10 w-full max-w-sm'>
      ...
      {open && term.length >= 2 && (
        <div className='absolute top-full w-full mt-2 rounded-md border border-input bg-popover dark:bg-input/30 text-popover-foreground shadow-md outline-none animate-in fade-in-0 zoom-in-95'>
          {results === undefined ? (
